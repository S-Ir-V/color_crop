...
def resnet365_backbone():
    arch = 'resnet18'
    model_file = '../premodel/resnet18_places365.pth.tar'
...
def mobile_net_v2(pretrained=False):
    ...
    if pretrained:
        ...
        path_to_model = '/root/tmp/pycharm_project_815/M_M_Semi-Supervised/color/AVA/pretrain_model/mobilenetv2.pth.tar'
