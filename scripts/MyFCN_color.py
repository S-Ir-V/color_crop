...
class MyFcn_color(chainer.Chain, a3c.A3CModel):

    def __init__(self, n_actions):
        w = chainer.initializers.HeNormal()
        net = MyFcn_trained()
        chainer.serializers.load_npz('../premodel/200model.npz', net)
        super(MyFcn_color, self).__init__(
            conv1=L.Convolution2D(3, 64, 3, stride=1, pad=1, nobias=False, initialW=net.conv1.W.data,
            ...
            conv8_pi=chainerrl.policies.SoftmaxPolicy(
                L.Convolution2D(64, n_actions, 3, stride=1, pad=1, nobias=False, initialW=w)),
